...
export const About = () => {
  return (
    <section id="about" className="py-3 bg-card relative">
      <div className="container mx-auto px-6 md:px-12">
        <div className="grid md:grid-cols-2 gap-20 items-center">
          <div className="relative">
            <div className="aspect-[6/5] rounded-2xl overflow-hidden filter grayscale hover:grayscale-0 transition-all duration-700">
              <img
                src="/office_img.png"
          ...
          <div className="space-y-8">
            <h2 className="text-4xl font-semibold text-foreground tracking-tight">Where Our Story Begins.</h2>
